function Individualize_ciftiSurf_resampledGroCon(subj)
...
RawDataFolder = '/scratch/abcdfnets/nda-abcd-s3-downloader/March_2021_DL/derivatives/abcd-hcp-pipeline';
subj_dtseries=['/scratch/abcdfnets/nda-abcd-s3-downloader/March_2021_DL/derivatives/abcd-hcp-pipeline/*/*/*/' subj '_ses-baselineYear1Arm1_p2mm_masked_concat.dtseries.nii*'];
